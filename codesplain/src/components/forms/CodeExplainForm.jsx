    ...
    return (
        <div className= "w-full max-w-4xl bg-white p-6 rounded-2xl shadow-lg text-black">
            <form action= {formAction}>
                ...
                <textarea name= "code" required placeholder= "Paste your code here..." className= "border rounded-lg w-full p-3 font-mono text-sm bg-transparent min-h-[300]px"></textarea>
